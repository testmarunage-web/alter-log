  ...
  return (
    <main className="min-h-screen bg-[#0B0E13] text-[#E8E3D8] flex flex-col selection:bg-[#C4A35A]/30">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 pt-32 pb-24 overflow-hidden">
        ...
        {/* Hero: 3枚横並び */}
        <div className="relative mt-16 w-full max-w-3xl mx-auto flex items-end justify-center gap-[3.5vw] sm:gap-6">
          <div className="w-full max-w-[min(200px,29vw)] origin-bottom opacity-75 scale-95 translate-y-3">
            <ScreenshotCard src="/images/screenshot-scan-top.jpg" alt="SCAN分析画面" />
          </div>
          <div className="z-10 w-full max-w-[min(240px,35vw)] origin-bottom scale-[1.03]">
