    ...
    <div className="mt-8 border-t border-dashed border-white/[0.08] pt-4">
      <div className="flex items-center gap-3">
        <button
          ...
          onClick={handleRun}
          disabled={loading}
          className="text-[10px] font-mono text-[#8A8276]/50 hover:text-[#C4A35A]/60 disabled:opacity-40 transition-colors border border-white/[0.08] hover:border-[#C4A35A]/20 rounded px-3 py-1.5 flex items-center gap-1.5"
        >
          {loading ? (
