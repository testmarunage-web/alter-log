    ...
    <main className="min-h-screen bg-[#0B0E13] text-[#E8E3D8]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm text-[#8A8276] leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-bold text-[#E8E3D8] mb-3">第4条（解約・返金・データ保持）</h2>
            <p>ユーザーはいつでも解約することができます。解約後は、その月の末日まで引き続きサービスをご利用いただけます。お申し込みから7日以内にご満足いただけない場合は、理由を問わず全額返金いたします。返金をご希望の場合は support@alter-log.com までご連絡ください。</p>
            <p className="mt-3">サブスクリプション解約後もアカウントおよびお客様のデータは保持され、過去の記録を閲覧いただけます。</p>
          </section>
          ...
          <section>
            ...
            <p>運営者は、ユーザーに通知することなく、当サービスの内容を変更することができます。やむを得ない事由により本サービスを終了する場合、30日前までにメール等でお客様に通知し、サービス終了後にお客様のデータを削除いたします。これ以外の理由によりユーザーに生じた損害について、運営者は一切の責任を負いません。</p>
          </section>
          ...
          <section>
            <h2 className="text-base font-bold text-[#E8E3D8] mb-3">第11条（アカウントの削除）</h2>
            <p>アカウントの削除をご希望の場合は、support@alter-log.com までご連絡ください。アカウント削除後30日以内に全てのデータを完全に削除いたします。</p>
          </section>
